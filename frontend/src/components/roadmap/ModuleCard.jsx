        ...
        {open && (
          ...
          >
            <div className="relative px-4 pb-4 pt-0 border-t border-white/8">
              <p className="text-xs text-white/45 my-3 leading-relaxed">
                {mod.description}
              </p>
              ...
              <div className="flex gap-2 flex-wrap">
                ...
                >
                  <motion.button
                    whileHover={{ scale: 1.03 }}
                    whileTap={{ scale: 0.97 }}
                    className="flex items-center gap-1.5 text-xs px-3 py-1.5 rounded-lg border border-white/10 text-white/45 bg-white/5 hover:bg-white/10 transition-colors cursor-pointer"
                  >
