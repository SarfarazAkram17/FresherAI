...
const Step2interview = ({ interviewData, user }) => {
  ...
  useEffect(() => {
    ...
    const runIntro = async () => {
      ...
      await speakText(
        `Welcome ${user?.name.split(" ")[0]}! Let's begin your interview.`,
      );
          ...
          <div className="flex flex-col items-center gap-1.5 pt-1">
            <div className="flex items-center justify-center gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.93 }}
                className={`w-10 h-10 rounded-xl flex items-center justify-center border cursor-pointer transition-all ${showMicon ? "bg-white/10 border-white/15 text-white" : "bg-red-500/20 border-red-500/30 text-red-400"}`}
              >
              ...
              <motion.button
                ...
                whileHover={{ scale: 1.08 }}
                whileTap={{ scale: 0.93 }}
                className={`w-10 h-10 rounded-xl flex items-center justify-center border cursor-pointer transition-all ${cameraOn ? "bg-white/10 border-white/15 text-white" : "bg-white/5 border-white/10 text-white/45 hover:text-white/70"}`}
              >
              ...
              <motion.button
                ...
                className="w-10 h-10 rounded-xl flex items-center justify-center border cursor-pointer transition-all bg-white/5 border-white/10 text-white/45 hover:text-white/70 hover:border-white/30"
              >
                <FiCode size={15} />
              </motion.button>
            </div>
            ...
            <span className="text-[10px] text-white/35 text-center">
              Coding question? Use{" "}
              <FiCode size={10} className="inline -mt-0.5" /> to write &amp; add
              code
            </span>
          </div>
        </div>
        ...
        <div className="flex flex-col p-4 sm:p-6">
          <div className="flex items-start justify-between mb-4">
            <div>
              ...
              <div className="flex items-center gap-2 text-zinc-500 text-xs mt-0.5 capitalize">
                <FiClock size={11} />
          ...
          <div className="flex items-center justify-between mt-4 pt-3 border-t border-white/8">
            ...
            <motion.button
              ...
              className="ml-auto h-10 min-w-37.5 justify-center px-5 rounded-xl bg-white text-black text-sm font-semibold flex items-center gap-2 disabled:opacity-40 transition cursor-pointer disabled:cursor-not-allowed"
            >
              {loading ? (
                <>
