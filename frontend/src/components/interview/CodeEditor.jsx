        ...
        >
            ...
            <div className="flex items-center gap-1.5 mx-auto">
              {LANG_OPTIONS.map((l) => (
                <button
                  ...
                  className={`text-xs px-2.5 py-1 rounded-lg capitalize transition-all cursor-pointer ${lang === l ? "bg-white text-[#0A0A0A] font-semibold" : "text-white/40 hover:text-white/70 hover:bg-white/8"}`}
                >
                  {l}
                </button>
              ))}
          ...
          <div className="relative border-t border-white/8 px-4 py-3 flex justify-end">
            <button
              ...
              className="flex items-center gap-1.5 text-xs px-4 py-2 rounded-lg bg-white text-[#0A0A0A] font-semibold hover:bg-white/90 transition-all cursor-pointer"
            >
              Add To Answer
            </button>
          </div>
