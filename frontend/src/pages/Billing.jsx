...
const Billing = ({ user, setUser }) => {
  ...
  const handlePayment = async (plan) => {
    ...
    try {
      const {data} = await api.post("/api/billing/create", {
      ...
      >
        <div className="mx-auto flex h-12 max-w-7xl items-center justify-between px-3 sm:px-5t">
          ...
          <button
            ...
            className="flex h-8 w-8 items-center justify-center rounded-lg border border-black/15 text-black/60 transition hover:border-black/35 hover:text-[#0A0A0A] cursor-pointer"
          >
              ...
              <div className="absolute right-1 top-11 z-40 w-60 max-w-[calc(100vw-24px)] rounded-xl overflow-hidden bg-[#000000]/90 backdrop-blur-2xl border border-white/10 p-3.5 shadow-[0_8px_32px_rgba(0,0,0,0.25)]">
                ...
                <div className="relative mt-3.5 rounded-lg border border-violet-400/20 bg-violet-500/10 p-2.5">
                  <p className="text-[10px] leading-4 text-violet-300">
                    Every AI feature uses Interview Coins. Buy more coins
                    anytime to continue using Resume Builder, Resume Scorer, AI
                    Interview and Roadmap Generator.
                  </p>
                </div>
              </div>
            </>
      ...
      <div className="mx-auto max-w-4xl px-4 py-6">
        <div className="text-center">
          ...
          <p className="mt-2 text-sm text-black/45">
            Use coins for Resume Scoring, Resume Builder, AI Interviews, and
            Roadmap Generation.
          </p>
        </div>
