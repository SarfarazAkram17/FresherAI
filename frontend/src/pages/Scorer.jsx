...
import { FiAlertCircle, FiUploadCloud, FiUser, FiZap } from "react-icons/fi";
...
const Navbar = ({ label }) => {
  ...
  return (
    ...
    >
      <div className="mx-auto flex h-12 max-w-7xl items-center justify-start px-3 sm:px-5t">
        <div
...
const Scorer = ({ user, setUser }) => {
  ...
  const uploadResume = async () => {
    ...
    try {
      ...
      try {
        const coinRes = await useCoins({ coins: 10, action: "resume-scorer" });
        ...
        <section className="max-w-6xl mx-auto px-3 pt-18 sm:pt-20 pb-8 space-y-3.5">
          ...
          <div className="flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between">
            ...
            <button
              ...
              className="text-[10px] sm:text-xs text-black/50 hover:text-[#0A0A0A] border border-black/15 hover:border-black/35 px-2.5 py-1 rounded-lg transition-colors cursor-pointer"
            >
              Re-upload
            </button>
          </div>
          ...
          <div className="grid grid-cols-1 gap-3 md:grid-cols-2">
            <motion.div
              ...
              className="relative overflow-hidden bg-[#000000]/90 backdrop-blur-2xl border border-white/10 rounded-2xl p-4 shadow-[0_8px_32px_rgba(0,0,0,0.2)]"
            >
    ...
    <div className="min-h-screen bg-white text-[#0A0A0A]">
      ...
      <section className="flex min-h-screen items-center justify-center px-3 pt-18 pb-6">
        ...
        >
          ...
          <label
            className={`relative flex flex-col items-center justify-center w-full h-40 sm:h-48 rounded-2xl border-2 border-dashed cursor-pointer transition-colors ${file ? "border-white/40 bg-white/6" : "border-white/15 bg-white/3 hover:border-white/30"}`}
          >
            <FiUploadCloud
          ...
          <motion.button
            ...
            className="relative mt-4 w-full h-10 rounded-xl cursor-pointer font-semibold text-xs bg-white text-[#0A0A0A] shadow-[0_4px_14px_rgba(255,255,255,0.15)] hover:bg-white/90 disabled:opacity-40 disabled:cursor-not-allowed transition-all"
          >
