    ...
    <div className="bg-white text-[#0A0A0A] font-sans min-h-screen overflow-x-hidden">
      ...
      >
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="bg-[#0A0A0A]/80 backdrop-blur-2xl text-white font-semibold border border-white/10 rounded-md px-3 py-1.5 text-sx cursor-pointer transition-all hover:border-white/20 shadow-[0_8px_24px_rgba(0,0,0,0.25)] flex items-center gap-2"
        >
          Log In <FaArrowRight />
        </motion.button>
      </motion.nav>
      ...
      <section className="relative pt-20 pb-14 overflow-hidden bg-[#F8F9FA]">
        <div className="absoulte top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-150 rounded-full bg-black/4 blur-[90px] pointer-events-none" />
        ...
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          >
            Fresher.AI is an innovative AI-powered interview preparation
          ...
          >
            ...
            >
              ...
              <span className="absolute inset-0 bg-linear-to-br from-white/1 via-transparent to-transparent" />
            </motion.button>
          </motion.div>
        </div>
      ...
      <section className="py-16 bg-[#F8F9FA]">
        <div className="max-w-5xl mx-auto px-6">
          <div className="text-center mb-10">
            ...
            <p className="text-black/40 text-sm leading-relaxed max-w-2xl mx-auto mt-4">
              Fresher.AI combines multiple AI agents that work together to help
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-4">
            {[
              ...
              },
              {
                ...
                desc: "Conduct realistic HR, Technical and Coding interview with AI-powered simulations.",
              },
              {
                icon: <FiBarChart2 />,
